...
from qai_hub_models.models.distil_bert_base_uncased_hf.demo import DEMO_TEXT
from qai_hub_models.models.distil_bert_base_uncased_hf.demo import main as demo_main
...
def test_task() -> None:
    model_cls = DistilbertBase.from_pretrained()
