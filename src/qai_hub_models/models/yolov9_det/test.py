...
from qai_hub_models.models.yolov9_det.demo import IMAGE_ADDRESS
from qai_hub_models.models.yolov9_det.demo import main as demo_main
...
def test_numerical() -> None:
    ...
    qaihm_model = YoloV9Detector.from_pretrained(WEIGHTS)
...
def test_task() -> None:
    ...
    app = YoloV9DetectionApp(YoloV9Detector.from_pretrained(WEIGHTS))
