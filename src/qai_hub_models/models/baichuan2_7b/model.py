...
def get_cached_asset(part: int) -> str:
    ...
    return os.path.join(model_path, f"weight_sharing_model_{part}_of_5.serialized.bin")
...
class PromptProcessor_Part1(BasePrecompiledModel):
    """
    Prompt Processor Part1 for Baichuan2 7B.
...
class PromptProcessor_Part2(BasePrecompiledModel):
    """
    Prompt Processor Part2 for Baichuan2 7B.
    ...
    def get_output_names(self) -> list[str]:
        return _get_output_names(start=0, end=7)
...
class PromptProcessor_Part3(BasePrecompiledModel):
    """
    Prompt Processor Part3 for Baichuan2 7B.
    ...
    def get_output_names(self) -> list[str]:
        return _get_output_names(start=7, end=14)
...
class PromptProcessor_Part4(BasePrecompiledModel):
    """
    Prompt Processor Part4 for Baichuan2 7B.
    ...
    def get_output_names(self) -> list[str]:
        return _get_output_names(start=14, end=21)
...
class PromptProcessor_Part5(BasePrecompiledModel):
    """
    Prompt Processor Part5 for Baichuan2 7B.
    ...
    def get_output_names(self) -> list[str]:
        return _get_output_names(start=21, end=28)
...
class TokenGenerator_Part1(BasePrecompiledModel):
    """
    Token Generator Part1 for Baichuan2 7B.
...
class TokenGenerator_Part2(BasePrecompiledModel):
    """
    Token Generator Part2 for Baichuan2 7B.
...
class TokenGenerator_Part3(BasePrecompiledModel):
    """
    Token Generator Part3 for Baichuan2 7B.
...
class TokenGenerator_Part4(BasePrecompiledModel):
    """
    Token Generator Part4 for Baichuan2 7B.
...
class TokenGenerator_Part5(BasePrecompiledModel):
    """
    Token Generator Part5 for Baichuan2 7B.
...
@PrecompiledCollectionModel.add_component(
    PromptProcessor_Part5, "prompt_processor_part_5"
)
@PrecompiledCollectionModel.add_component(
...
@PrecompiledCollectionModel.add_component(
    TokenGenerator_Part5, "token_generator_part_5"
)
class Baichuan2_7B_Quantized(PrecompiledCollectionModel):
    """
    Baichuan2_7B_Quantized class consists of
