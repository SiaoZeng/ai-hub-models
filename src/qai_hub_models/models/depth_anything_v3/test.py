...
from qai_hub_models.models.depth_anything_v3.demo import INPUT_IMAGE_ADDRESS
from qai_hub_models.models.depth_anything_v3.demo import main as demo_main
