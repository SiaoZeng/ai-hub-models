...
from qai_hub_models.models.bert_base_uncased_hf.demo import DEMO_TEXT
from qai_hub_models.models.bert_base_uncased_hf.demo import main as demo_main
from qai_hub_models.models.bert_base_uncased_hf.model import (
    BertBaseUncasedHf,
)
...
def test_task() -> None:
    model_cls = BertBaseUncasedHf.from_pretrained()
