...
This is based on the implementation of IndusQ-1.1B found [here](https://huggingface.co/nickmalhotra/ProjectIndus).
This repository contains scripts for optimized on-device export suitable to run on Qualcomm® devices. More details on model performance across various devices, can be found [here](https://aihub.qualcomm.com/models/indus_1b).
